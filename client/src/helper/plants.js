import gardenCare from "../assets/gardenCare.webp";
import pickYourPlant from "../assets/pickYourPlant.webp";
import plantRenovation from "../assets/plantRenovation.webp";
import wateringGraden from "../assets/wateringGraden.webp";

export const plantJson = [
  {
    id: 1,
...
export const threePotsData = [
  {
    image:
      "https://gateway.pinata.cloud/ipfs/QmazPBoXutApUv9FHDFk5gBxtVEVLqCH1SffaT2uXGBQgC",
    name: "Air Purifying",
    bg: "#ebedec",
  },
  {
    image:
      "https://gateway.pinata.cloud/ipfs/QmeAJoRndANpiZJA8d6AVPBsLxUtP5b2Lx8HHYBwo2mm29",
    name: "Ceramic Pots",
    bg: "#c9c2b7",
  },
  {
    image:
      "https://gateway.pinata.cloud/ipfs/QmUjc512FH2gq2QYU3DY4E44BwhW6LFrK3TNrfUjuag9rP",
    name: "House Plants",
    bg: "#f5f3f0",
  },
];
...
export const fourPointsData = [
  {
    ...
    text: "Let’s find a plant ",
  },
  {
    image: plantRenovation,
    textMain: "Plant Renovation",
    text: "For all orders above ",
  },
  {
    image: pickYourPlant,
    textMain: "Pick your plant",
    text: "For all orders above ",
  },
  {
    image: wateringGraden,
